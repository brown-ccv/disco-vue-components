...
export const Template = (args, { argTypes }) => ({
  ...
  template: `
        <div>
          ...
          <DModal v-if="show" :variant="variant" :accent="accent" :width="width" :closeOptions="closeOptions" :closeButtonText="closeButtonText" @close="show = !show">
            <template #content>
              <div class="content">
                <h1>Lorem ipsum</h1>
...
<Canvas>
  <Story name="Modal" args={{variant: 'light', accent: 'warning', width: 'small', closeOptions: 'both', closeButtonText: 'Close'}}>
    {Template.bind({})}
  </Story>
</Canvas>
